...
from attack.transfer_attack.utils.cam import CAM
from attack.transfer_attack.utils.transfrom import op, op_bk
...
class SFCoT(ATTACK):
    ...
    def attack(self,m):
        ...
        data_loader = DataLoader(
            self.dataset, batch_size=args.batch_size, num_workers=4
        )
    ...
    def SFT(self, images, te, model):
        ...
        if not self.args.no_sp:
            for image in images:
                ...
                cam = CAM(image, self.net,False, th=self.args.th)
                cam_list.append(cam)
        eps = args.eps / 255.0
